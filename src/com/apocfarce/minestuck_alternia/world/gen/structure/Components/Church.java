...
public class Church extends VillageComponentInterface
{
    public Church()
    {
    }

    public Church(AlterniaVillageStart start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
    {
        super(start, type);
    ...
    public static Church createPiece(AlterniaVillageStart start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
    {
