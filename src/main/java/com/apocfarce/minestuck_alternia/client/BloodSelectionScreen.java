...
public class BloodSelectionScreen extends Screen {
	...
	protected void init() {
		for(BloodColor color : BloodColor.values()) {
			...
			addButton(new Button(x, y, 100, 20, I18n.format(color.getTranslationKey()), button -> pickColor(color)));
		}
	}
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(font, I18n.format(PROMPT), width/2, height/2 - 80, 0xFFFFFF);
	}
