...
public class AlterniaLayerUtil extends LayerUtil {
   ...
   public static <T extends IArea, C extends IExtendedNoiseRandom<T>> ImmutableList<IAreaFactory<T>> buildAlterniaProcedure(WorldType worldTypeIn, AlterniaGenSettings settings, LongFunction<C> contextFactory) {
//------------------------------------
...
//--------------------------------------------
      ...
      iareafactory = AddBambooForestLayer.INSTANCE.apply(contextFactory.apply(1001L), iareafactory);
...
//----------------------------
   ...
   public static Layer[] buildAlterniaProcedure(long seed, WorldType typeIn, AlterniaGenSettings settings) {
	      int i = 25;
