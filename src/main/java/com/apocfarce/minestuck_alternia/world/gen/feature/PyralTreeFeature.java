...
public class PyralTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState TRUNK = AlterniaBlocks.pyralLog.getDefaultState();
   private static final BlockState LEAF = AlterniaBlocks.pyralLeaves.getDefaultState();

   public PyralTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51429_1_, boolean p_i51429_2_) {
      super(p_i51429_1_, p_i51429_2_);
      setSapling((net.minecraftforge.common.IPlantable)AlterniaBlocks.pyralSapling);
   }
