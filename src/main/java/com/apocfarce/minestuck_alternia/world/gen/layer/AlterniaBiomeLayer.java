...
public class AlterniaBiomeLayer implements IC0Transformer {
	...
	public AlterniaBiomeLayer(WorldType p_i48641_1_, AlterniaGenSettings p_i48641_2_) {
		for (BiomeType type : BiomeType.values()) {
			
			ImmutableList<BiomeEntry> biomesToAdd = AlterniaBiomeHandeler.getBiomes(type);
