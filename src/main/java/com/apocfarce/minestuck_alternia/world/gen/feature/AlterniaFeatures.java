...
public class AlterniaFeatures {
	...
	public static ConfiguredFeature<?, ?> PYRAL_TREES;
	public static ConfiguredFeature<?, ?> MIRRAGE_TREES;
	
	public static ConfiguredFeature<?, ?> PYRAL_GRASS;
