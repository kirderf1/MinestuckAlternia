...
public class AlterniaFeatures {
	...
	public static final ConfiguredFeature<?, ?> COAL_ORE = register("coal_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_COAL_ORE.getDefaultState(), 17)).range(128).square().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> IRON_ORE = register("iron_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_IRON_ORE.getDefaultState(), 9)).range(64).square().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> GOLD_ORE = register("gold_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_GOLD_ORE.getDefaultState(), 9)).range(32).square().func_242731_b(2));
	public static final ConfiguredFeature<?, ?> REDSTONE_ORE = register("redstone_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_REDSTONE_ORE.getDefaultState(), 8)).range(16).square().func_242731_b(8));
	public static final ConfiguredFeature<?, ?> DIAMOND_ORE = register("diamond_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_DIAMOND_ORE.getDefaultState(), 8)).range(16).square());
	public static final ConfiguredFeature<?, ?> LAPIS_ORE = register("lapis_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.darkStone(), AlterniaBlocks.DARK_STONE_LAPIS_ORE.getDefaultState(), 7)).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(16, 16))).square());
