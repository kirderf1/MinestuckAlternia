...
public class AlterniaFeatures {
	...
	public static final Feature<LakesFeatureConfig> LAKE = new ModifiedLakesFeature(LakesFeatureConfig.CODEC);
	...
	public static final ConfiguredFeature<?, ?> RED_ROCK_ORE = register("red_rock_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.RED_ROCK.getDefaultState(), 33)).range(256).square().func_242731_b(10));
	public static final ConfiguredFeature<?, ?> COAL_ORE = register("coal_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_COAL_ORE.getDefaultState(), 17)).range(128).square().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> IRON_ORE = register("iron_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_IRON_ORE.getDefaultState(), 9)).range(64).square().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> GOLD_ORE = register("gold_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_GOLD_ORE.getDefaultState(), 9)).range(32).square().func_242731_b(2));
	public static final ConfiguredFeature<?, ?> REDSTONE_ORE = register("redstone_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_REDSTONE_ORE.getDefaultState(), 8)).range(16).square().func_242731_b(8));
	public static final ConfiguredFeature<?, ?> DIAMOND_ORE = register("diamond_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_DIAMOND_ORE.getDefaultState(), 8)).range(16).square());
	public static final ConfiguredFeature<?, ?> LAPIS_ORE = register("lapis_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(AlterniaFillerBlockTypes.alterniaStone(), AlterniaBlocks.DARK_STONE_LAPIS_ORE.getDefaultState(), 7)).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(16, 16))).square());
	
	@SuppressWarnings("Convert2MethodRef")
	private static final LakesFeatureConfig LAVA_LAKE_CONFIG = new LakesFeatureConfig(() -> Blocks.LAVA.getDefaultState(), () -> AlterniaBlocks.DARK_STONE.getDefaultState());
	public static final ConfiguredFeature<?, ?> WATER_LAKE = register("water_lake", AlterniaFeatures.LAKE.withConfiguration(new LakesFeatureConfig(Blocks.WATER.getDefaultState())).withPlacement(Placement.WATER_LAKE.configure(new ChanceConfig(4))));
	public static final ConfiguredFeature<?, ?> LAVA_LAKE = register("lava_lake", AlterniaFeatures.LAKE.withConfiguration(LAVA_LAKE_CONFIG).withPlacement(Placement.LAVA_LAKE.configure(new ChanceConfig(80))));
	public static final ConfiguredFeature<?, ?> COMMON_LAVA_LAKE = register("common_lava_lake", AlterniaFeatures.LAKE.withConfiguration(LAVA_LAKE_CONFIG).withPlacement(Placement.LAVA_LAKE.configure(new ChanceConfig(10))));
